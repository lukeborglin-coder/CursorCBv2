  ...
  class ChartColorMatcher {
    constructor() {
      ...
      this.orangeGrayPalette = [
        '#D14829','#4a5568','#e86900','#a0aec0','#ff9500','#2d3748','#ffb84d','#718096',
      ...
      this.productColors = {
        'evrysdi':'#D14829','risdiplam':'#D14829',
    ...
    getContrastingColor(base) {
      const oranges = ['#D14829','#e86900','#ff9500','#ffb84d','#cc5500','#ff6600'];
    ...
    generateContextualPalette(colorHints = [], productMentions = []) {
      ...
      colorHints.forEach(h => {
        ...
        const map = {
          orange:'#D14829', blue:'#2563eb', green:'#16a34a', red:'#dc2626',
